...
public class PrecisionSquare extends AppCompatActivity {
    ...
    public void activate() {
        touchView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                disable();
                // TODO Voltar a inserir esta parte, depois de implementar fragmento que permita mudar de esquema
                /*
    ...
    public void disable() {
        Intent intent = new Intent(getApplicationContext(), Complimentary.class);
        finishActivity(2);
...
/*
 TODO LIST :
    ...
    TODO Apresentar informações sobre a cor atual
 */
